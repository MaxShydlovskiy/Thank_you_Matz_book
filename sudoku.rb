...
# including newlines, will be stripped.
    ...
    def []=(row, col, newvalue)
      #Raise an exeption unless the new value in the range 0 to 9
    ...
    def has_duplicates?
      ...
      false
    end           # If all the tests have passed, then the board has no duplicates
  ...
  def Sudoku.scan(puzzle)
    ...
    until unchanged
      ...
      # More than the maximal number of possibilities
      ...
      puzzle.each_unknown do |row, col, box|
        ...
        when 1 # We've found a unique value, so set it in the grid
          ...
          # For any other number of possibilities
